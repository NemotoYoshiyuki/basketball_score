...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Home Player'), array('action' => 'delete', $this->Form->value('HomePlayer.id')), array(), __('このレコードを消去しますか？ # %s?', $this->Form->value('HomePlayer.id'))); ?> </li>
